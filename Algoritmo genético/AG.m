...
global size_string
size_string=100;%Largo del string
generaciones=40;%Cantidad de generaciones
size_torneo = 2; %Tamaño torneo
poblacion_elite=8; %Tamaño de la población de elite
...
function [valor_fitness] = Fitness(string)
    ...
    if (contador>0)
        global ENRON
        columnasSeleccionadas=ENRON(1:end,lista_columnas);
        clasificaciones=ENRON(1:end,101);
